...
##   - Translated by: Samuel Low, 01-07-2019, DSO National Laboratories      ##
##                                                                           ##
###############################################################################
###############################################################################
'''
...
def LAMBDA( ahat, Qahat, ncands = 2 ):
    ...
    # [afixed1,afixed2,sqnorm]=LAMBDA(ahat,Qahat,ncands)
    #
    ...
    # OUTPUTS:
    #
    #  afixed1: Best estimated integer candidates, sorted according to the
    #           corresponding squared norms.
    #  afixed2: 2nd best estimated integer candidates, sorted according to the
    #           corresponding squared norms.
    ...
    return afixed[0], afixed[1], sqnorm
